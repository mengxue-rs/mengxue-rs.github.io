...
<div class="p-4">
    ...
    <p>
        ...
        • Model calibration alleviates the distributional shift of overconfident probabilities. <br>
        • An entropy-based uncertainty framework is formulated for DL drought detection. <br>
